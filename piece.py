...
class Pawn(Piece):
    ...
    def get_legal_moves(self, board):
        # Checks for legal moves for a pawn. Considers the following cases:
        # 1. Pawn has not moved yet (can move 1 or 2 squares)
        # 2. Pawn has moved (can only move 1 square)
        # 3. Pawn can capture a piece diagonally
        # 4. Pawn can capture a piece en passant
        # 5. Move is not legal if it puts the king in check
        # To check squares on the board, we use the get_piece_by_coordinates method of the Board class.
        # For usage of this method, h1 is (0, 0) and a8 is (7, 7).
        ...
        if color == 'white':
            # if the pawn can move one square up
            if y < 7 and board.get_piece_by_coordinates(x, y + 1) is None:
                moves.append((x, y + 1))
                # if the pawn has not moved yet and can move two squares up
                if not self.moved and board.get_piece_by_coordinates(x, y + 2) is None:
                    moves.append((x, y + 2))
            # if the pawn can capture a piece diagonally to the right
            if y < 7 and x < 7:
                piece = board.get_piece_by_coordinates(x + 1, y + 1)
            ...
            if y == 4 and x < 7:
                piece = board.get_piece_by_coordinates(x + 1, y)
                if piece is not None and piece.color == 'black' and piece.piece_type == 'pawn' and piece.moved:
                    moves.append((x + 1, y + 1))
        ...
        # if the pawn is black
            ...
            # if the pawn can move one square down
            if y > 0 and board.get_piece_by_coordinates(x, y - 1) is None:
                moves.append((x, y - 1))
                # if the pawn has not moved yet and can move two squares down
                if not self.moved and board.get_piece_by_coordinates(x, y - 2) is None:
                    moves.append((x, y - 2))
            # if the pawn can capture a piece diagonally to the right
            if y > 0 and x < 7:
            ...
            if y == 3 and x < 7:
                piece = board.get_piece_by_coordinates(x + 1, y)
                if piece is not None and piece.color == 'white' and piece.piece_type == 'pawn' and piece.moved:
                    moves.append((x + 1, y - 1))
            # if the pawn can capture a piece en passant to the left
            if y == 3 and x > 0:
                piece = board.get_piece_by_coordinates(x - 1, y)
...
class Rook(Piece):
    ...
    def get_legal_moves(self, board):
        ...
        if color == 'white':
            ...
            for i in range(1, 8):
                if y - i >= 0:
                    if board.board[y - i][x] is None:
                        moves.append((x, y - i))
                    elif board.board[y - i][x].color == 'black':
                        moves.append((x, y - i))
                        break
                    else:
                        break
            ...
            for i in range(1, 8):
                if x - i >= 0:
                    if board.board[y][x - i] is None:
                        moves.append((x - i, y))
                    elif board.board[y][x - i].color == 'black':
                        moves.append((x - i, y))
                        break
                    else:
                        break
        ...
        # if the rook is black
            ...
            for i in range(1, 8):
                if y - i >= 0:
                    if board.board[y - i][x] is None:
                        moves.append((x, y - i))
                    elif board.board[y - i][x].color == 'white':
                        moves.append((x, y - i))
                        break
                    else:
                        break
            ...
            for i in range(1, 8):
                if x - i >= 0:
                    if board.board[y][x - i] is None:
                        moves.append((x - i, y))
                    elif board.board[y][x - i].color == 'white':
                        moves.append((x - i, y))
                        break
                    else:
                        break
...
class Queen(Piece):
    ...
    def get_legal_moves(self, board):
        ...
        if color == 'white':
            ...
            for i in range(1, 8):
                if x - i >= 0 and y - i >= 0:
                    if board.board[y - i][x - i] is None:
                        moves.append((x - i, y - i))
                    elif board.board[y - i][x - i].color == 'black':
                        moves.append((x - i, y - i))
                        break
                    else:
                        break
        ...
        # if the queen is black
            ...
            for i in range(1, 8):
                if x - i >= 0 and y - i >= 0:
                    if board.board[y - i][x - i] is None:
                        moves.append((x - i, y - i))
                    elif board.board[y - i][x - i].color == 'white':
                        moves.append((x - i, y - i))
                        break
                    else:
                        break
...
class King(Piece):
    ...
    def get_legal_moves(self, board):
        ...
        if color == 'white':
            ...
            if y - 1 >= 0:
                if board.board[y - 1][x] is None:
                    if not board.would_be_in_check(self, (x, y - 1)):
                        moves.append((x, y - 1))
                elif board.board[y - 1][x].color == 'black':
                    if not board.would_be_in_check(self, (x, y - 1)):
                        moves.append((x, y - 1))
            ...
            if x - 1 >= 0:
                if board.board[y][x - 1] is None:
                    if not board.would_be_in_check(self, (x - 1, y)):
                        moves.append((x - 1, y))
                elif board.board[y][x - 1].color == 'black':
                    if not board.would_be_in_check(self, (x - 1, y)):
                        moves.append((x - 1, y))
            ...
            if x - 1 >= 0 and y - 1 >= 0:
                if board.board[y - 1][x - 1] is None:
                    if not board.would_be_in_check(self, (x - 1, y - 1)):
                        moves.append((x - 1, y - 1))
                elif board.board[y - 1][x - 1].color == 'black':
                    if not board.would_be_in_check(self, (x - 1, y - 1)):
                        moves.append((x - 1, y - 1))
            ...
            if not self.has_moved:
                ...
                if board.board[7][5] is None and board.board[7][6] is None:
        ...
        # if the king is black
            ...
            if y - 1 >= 0:
                if board.board[y - 1][x] is None:
                    if not board.would_be_in_check(self, (x, y - 1)):
                        moves.append((x, y - 1))
                elif board.board[y - 1][x].color == 'white':
                    if not board.would_be_in_check(self, (x, y - 1)):
                        moves.append((x, y - 1))
            # if the king can move down
            if y + 1 <= 7:
            ...
            if x - 1 >= 0:
                if board.board[y][x - 1] is None:
                    if not board.would_be_in_check(self, (x - 1, y)):
                        moves.append((x - 1, y))
                elif board.board[y][x - 1].color == 'white':
                    if not board.would_be_in_check(self, (x - 1, y)):
                        moves.append((x - 1, y))
            # if the king can move to the right
            if x + 1 <= 7:
            ...
            if x - 1 >= 0 and y - 1 >= 0:
                if board.board[y - 1][x - 1] is None:
                    if not board.would_be_in_check(self, (x - 1, y - 1)):
                        moves.append((x - 1, y - 1))
                elif board.board[y - 1][x - 1].color == 'white':
                    if not board.would_be_in_check(self, (x - 1, y - 1)):
                        moves.append((x - 1, y - 1))
            # if the king can move up and to the right
            if x + 1 <= 7 and y - 1 >= 0:
